...
# Dash
# ---------------------------------------------------------------------------
DASH_SPEED:    float = 1400.0   # px/s during dash
DASH_DURATION: float = 0.18     # seconds the dash lasts
DASH_COOLDOWN: float = 0.60     # seconds before next dash

# ---------------------------------------------------------------------------
# Invincibility (after respawn)
# ---------------------------------------------------------------------------
INVINCIBLE_DURATION: float = 1.5   # seconds of post-respawn invincibility

# ---------------------------------------------------------------------------
# Coyote time & jump buffer
# ---------------------------------------------------------------------------
COYOTE_TIME:      float = 0.10   # seconds grace to jump after leaving a ledge
JUMP_BUFFER_TIME: float = 0.12   # seconds early-jump input is remembered

# ---------------------------------------------------------------------------
# Death freeze frame
# ---------------------------------------------------------------------------
DEATH_FREEZE_TIME: float = 0.35  # seconds game freezes on death for dramatic impact

# ---------------------------------------------------------------------------
# Kill combo window
# ---------------------------------------------------------------------------
KILL_COMBO_WINDOW: float = 2.0   # seconds between kills to maintain streak
