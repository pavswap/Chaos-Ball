...
def _gen_void_walls(r):
    ...
    The side is randomised per level so the layout feels different each time.
    """
...
def generate_level(level_idx, seed=None):
    ...
    # ── Void walls: on EVERY level, always 1 vertical + 1 horizontal ─────
    void_walls = _gen_void_walls(r)
